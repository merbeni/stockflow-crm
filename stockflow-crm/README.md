...
> **Estado actual: 291 pruebas en verde** (221 de backend + 70 de frontend). La estrategia
...
| **Casos de prueba** | `docs/test-cases/` | 222 casos que documentan la suite automatizada, agrupados en 10 módulos. |
| **Plan de pruebas** | [`docs/test-plan/PLAN_DE_PRUEBAS.md`](docs/test-plan/PLAN_DE_PRUEBAS.md) | Estrategia, técnicas de diseño, casos negativos y de límite por módulo, seguridad y aislamiento multiempresa, usabilidad (heurísticas de Nielsen), accesibilidad WCAG 2.1 AA, gestión de defectos y **registro de los 44 defectos encontrados y corregidos**. |
